import { Button, Card, Form, Image, Input, Typography, Avatar, Spin, message, DatePicker } from 'antd'
                ...
                <Form className="form-group">
                  <Form.Item>
                      <div className="form-group">
                        ...
                        <Input style={{border: '2px solid #0de2e2', marginTop: "10px", height:"40px", width: "100%"}} size="medium" placeholder="Create a name..." value={name} onChange={(e)=> setName(e.target.value)}/>
                      </div>
                  </Form.Item>
                  <Form.Item>
                      <Typography.Text style={{fontWeight: "bolder", fontSize:"16px"}}>Description of NFT</Typography.Text>
                      <Input style={{border: '2px solid #0de2e2', marginTop: "10px", height:"40px",  width: "100%"}} size="medium" placeholder="Create a description..." value={description} onChange={(e)=> setDescription(e.target.value)}/>
                  </Form.Item>
                  <Form.Item>
                      <div className="form-group">
                        <Typography.Text style={{fontWeight: "bolder", fontSize:"16px"}}>Degree Name</Typography.Text>
                        <Input style={{border: '2px solid #0de2e2', marginTop: "10px", height:"40px", width: "100%"}} size="medium" placeholder="Degree Name" value={degree} onChange={(e)=> setDegree(e.target.value)}/>
                      </div>
                  </Form.Item>
                  <Form.Item>
                      <Typography.Text style={{fontWeight: "bolder", fontSize:"16px"}}>Faculty</Typography.Text>
                      <Input style={{border: '2px solid #0de2e2', marginTop: "10px", height:"40px",  width: "100%"}} size="medium" placeholder="Faculty" value={faculty} onChange={(e)=> setFaculty(e.target.value)}/>
                  </Form.Item>
                  <Form.Item>
                      <Typography.Text style={{fontWeight: "bolder", fontSize:"16px"}}>Date</Typography.Text>
                      <Input style={{border: '2px solid #0de2e2', marginTop: "10px", height:"40px",  width: "100%"}} size="medium" placeholder="Date" value={gradDate} onChange={(e)=> setGradDate(e.target.value)}/>
                  </Form.Item>
                  <Form.Item>
                    <Button onClick={handleNFT} type="primary" shape="square" size='large' style={{width: "100%", height:"60px", marginTop: "10px"}}>
                      Generate & Mint
                    </Button>
                  </Form.Item>
                </Form>
