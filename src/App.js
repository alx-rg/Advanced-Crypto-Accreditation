                ...
                <Form className="form-group">
                  ...
                  <Form.Item>
                      <div className="form-group">
                        ...
                        <Input style={{border: '2px solid #0de2e2', marginTop: "10px", height:"60px", width: "100%"}} size="medium" placeholder="Degree Name" value={degree} onChange={(e)=> setDegree(e.target.value)}/>
                      </div>
                  </Form.Item>
                  <Form.Item>
                      <Typography.Text style={{fontWeight: "bolder", fontSize:"16px"}}>Faculty</Typography.Text>
                      <Input style={{border: '2px solid #0de2e2', marginTop: "10px", height:"60px",  width: "100%"}} size="medium" placeholder="Faculty" value={faculty} onChange={(e)=> setFaculty(e.target.value)}/>
                  </Form.Item>
                  <Form.Item>
                    <DatePicker value={gradDate} onChange={(e) => setGradDate(e.target.value)} picker="year" />
                  </Form.Item>
